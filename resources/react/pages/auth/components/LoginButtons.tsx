import { AuthRoutes, SwitchView } from "../AuthPage";
...
export function LoginButtons({routes, switchView}: LoginButtonsProps) {

    return (<div className="flex w-fit flex-col gap-3">
                <a
                    href={routes.google}
